...
public class SignUpPage extends BasePage {
    ...
    private void validateSignUp() {
        ...
        try (java.sql.Connection conn = com.library.common.DatabaseConnection.getConnection();
            ...
            // For now, using email prefix as Name
            ...
            // Note: Password handling should ideally be in another table or hashed.
            // For simplicity in this demo, we are matching User schema provided.
            ...
            if (e.getErrorCode() == 1062) { // Duplicate entry
                showMessage("Error", "Email already exists", false);
            } else {
                e.printStackTrace();
